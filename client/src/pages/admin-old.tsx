    ...
    <Card>
      ...
      <CardContent>
        <div className="space-y-6">
          ...
          <div>
            <h3 className="font-medium mb-3">Moderation Settings</h3>
            <div className="space-y-2">
              <label className="flex items-center space-x-2">
                <input type="checkbox" className="rounded" />
                <span className="text-sm">Auto-moderate flagged content</span>
              </label>
              <label className="flex items-center space-x-2">
                <input type="checkbox" className="rounded" />
                <span className="text-sm">Require verification for introductions</span>
              </label>
            </div>
          </div>
